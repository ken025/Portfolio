        ...
        <Container>
            <Row>
                ...
                <Col xs={6} md={10}>
                    ...
                    <Button href="https://docs.google.com/document/d/1yJGRuDhLW-mOsPDwK2OG3Z3KJOmDNOxJ7l319snWUWI/edit?usp=sharing" target="_blank"> <AiOutlineFileDone size={30}/>My Resumé </Button><br/>
                </Col>
            </Row>
        </Container>
        </>
