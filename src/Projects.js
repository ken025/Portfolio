        ...
        <Jumbotron>
            <h4 id="title">Percentage</h4><br/>
                    ...
                    <Jumbotron>
                        ...
                        <p>JavaScript application for users to create and post pins of fashion, cuisine, and interior design</p>
                        <a href="https://github.com/ken025/Accent-JS-Project.git" target="_blank"> GitHub Repo </a>
               
            </Jumbotron>

                <Jumbotron>
                    <h4 id="title">Let’s Taco Bout It</h4><br/>
